...
class Text2SQLQueryLogRepository:
    ...
    def get_success_log_for_owner(self, *, log_id: int, user_id: int) -> Text2SQLQueryLog | None:
        """Read a successful query log by owner for trusted few-shot backflow."""
        self.ensure_feedback_score_column()
        row = self.db.execute(
            text(
                """
        ...
        return Text2SQLQueryLog(
            ...
            error_message=None,
            selected_tables=row.get("selected_tables"),
